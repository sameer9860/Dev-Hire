...
# Developer OAuth (Google / GitHub) — leave blank to disable until configured
...
# Email settings (for password reset emails)
...
PASSWORD_RESET_REQUEST_WINDOW = config('PASSWORD_RESET_REQUEST_WINDOW', default=3600, cast=int)
